...
\begin{tikzpicture}[
  ...
  \node[eq, right=4.4cm of mid1] (eqg) {
    {\Large\bfseries Gaussian Model}\\[0.2em]
    $\displaystyle S(t)=\sum_i\frac{A_i}{\sigma_i\sqrt{2\pi}}
      \exp\!\left(-\frac{(t-t_0)^2}{2\sigma_i^2}\right)$\\[0.15em]
    {\small single Gaussian: one term \,$(i=1)$}
  };
